...
HARD_BANS = {
    ...
    "黑话（模型腔）": re.compile(
        r"赋能|抓手|闭环|底层逻辑|顶层设计|降本增效|全链路|组合拳|颗粒度|"
        r"方法论|对齐|沉淀|商业闭环|护城河|第二曲线|心智|赛道|生态位|势能"
    ),
...
def detect(text: str):
    ...
    # 引语冒号豁免：冒号后紧跟中文引号「"『 或 「XXX」形式的直接引语
    def _is_quote_colon(match):
        return False  # 简化：任何中文冒号都报，由人工判断是否为引语
