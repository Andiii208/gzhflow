...
```html
<section style="max-width:677px;margin:0 auto;padding:8px;box-sizing:border-box;background:#fdfdf8;color:#4d4f46;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','Source Han Serif SC','SimSun',serif;line-height:1.75;">
...
<section style="margin-top:24px;">
  <section style="font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#eeefe9;border:1px solid #bfc1b7;border-radius:6px;padding:12px 16px;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#1e1f23;border:1px solid #23251d;border-radius:6px;overflow:hidden;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#fdfdf8;border:1px solid #bfc1b7;border-radius:6px;padding:14px 16px;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;display:flex;align-items:center;justify-content:space-between;gap:10px;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#fdfdf8;border:1px solid #bfc1b7;border-radius:6px;overflow:hidden;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="display:flex;align-items:center;justify-content:center;gap:10px;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="padding:0 8px;margin:0 -8px;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <figure style="font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;margin:0;">
...
```html
<section style="margin-top:24px;">
  <section style="padding:18px;border-radius:6px;background:#fdfdf8;border:1px solid #bfc1b7;text-align:center;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#eeefe9;padding:16px;border-radius:6px;border:1px solid #bfc1b7;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="border-radius:6px;overflow:hidden;border:1px solid #bfc1b7;background:#fdfdf8;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#eeefe9;border-radius:6px;padding:22px 18px;border:1px solid #bfc1b7;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
    ...
    <svg viewBox="0 0 400 82" style="width:100%;height:auto;" role="img" aria-label="流程示意">
      ...
      <text x="31" y="34" font-size="9" fill="#23251d" text-anchor="middle" font-weight="700" font-family="IBM Plex Sans,serif"><tspan leaf="">节点一</tspan></text>
...
```html
<section style="margin-top:24px;">
  <section style="background:#fdfdf8;border:1px solid #bfc1b7;padding:18px;box-sizing:border-box;border-radius:6px;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="padding:18px;border-radius:6px;background:#fdfdf8;border:1px solid #bfc1b7;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#fdfdf8;border:1px solid #bfc1b7;border-radius:6px;padding:22px 16px;text-align:center;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="border-radius:6px;overflow:hidden;border:1px solid #23251d;background:#1e1f23;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;display:flex;align-items:stretch;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#1e1f23;border:1px solid #23251d;padding:8px;box-sizing:border-box;border-radius:6px;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
...
```html
<section style="margin-top:24px;">
  <section style="background:#eeefe9;border:1px solid #bfc1b7;border-radius:6px;overflow:hidden;font-family:'IBM Plex Sans','Songti SC','Noto Serif CJK SC','SimSun',serif;">
    <section style="padding:12px 16px;display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">
