...
字体栈：`'Songti SC','Noto Serif CJK SC','Source Han Serif SC','SimSun',serif`
...
```html
<section style="max-width:677px;margin:0 auto;background:#ffffff;font-family:'Songti SC','Noto Serif CJK SC','Source Han Serif SC','SimSun',serif;color:#374151;line-height:1.75;letter-spacing:0.5px;overflow-x:hidden;">
